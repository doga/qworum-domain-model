  ...
  constructor(group) {
    ...
    if (group.isPersonalGroup) {
      ...
      if (!group.partnershipsManagerIds) {
        group.partnershipsManagerIds = group.ownerIds.filter(id => true);
      }
...
class PersonalGroup extends Group {
  /**
   * 
   * @param {{groupId: GroupId | undefined, partnershipId: PartnershipId | undefined, ownerIds: UserId[], partnershipsManagerIds: UserId[] | undefined, membershipsManagerIds: UserId[] | undefined, memberIds: UserId[] | undefined}} group
   * @throws {TypeError}
   */
  constructor(group) {
    super({
