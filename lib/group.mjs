...
class Group {
   ...
   * - The memberships manager hasn't explicity assigned R1 to the end-user, and hasn't assigned any other role from RS1 either; in this case the end-user has R1 only if this flag is set to `true`.
   * 
   * @returns {boolean}
   */
