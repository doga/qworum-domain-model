...
class Org {
   ...
   */
  constructor(org) {
    org.rootGroupsManagerIds  = org.rootGroupsManagerIds ?? [];
...
class Group { // BUG personal group semantics are not enforced (parent group can be set for personal group, etc )
   ...
   * 
   * @param {{groupId: GroupId | undefined, isPersonalGroup: boolean | undefined, orgId: OrgId | undefined, parentGroupId: GroupId | undefined, ownerIds: UserId[], subgroupsManagerIds: UserId[] | undefined, partnershipsManagerIds: UserId[] | undefined, membershipsManagerIds: UserId[] | undefined, memberIds: UserId[] | undefined}} group
   * @throws {TypeError}
   */
  constructor(group) {
    if(!(
