...
class Group {
   ...
   * 
   * For personal groups, the ownerIds array must contain one UserId and isPersonalGroup must be truthy and these fields must be omitted: orgId, parentGroupId, subgroupsManagerIds. If these fields are omitted for personal group, then will be set to ownerIds: partnershipsManagerIds, membershipsManagerIds.
   * 
