...
class Org {
  ...
  /**
   * 
   * @param {{orgId: OrgId | undefined, ownerIds: UserId[], rootGroupsManagerIds: UserId[], membershipsManagerIds: UserId[], memberIds: UserId[], }} org 
   */
  constructor(org) {
...
class Group {
  ...
  /**
   * 
   * @param {{groupId: GroupId | undefined, isPersonalGroup: boolean | undefined, orgId: OrgId | undefined, parentGroupId: GroupId | undefined, collabId: CollabId | undefined, ownerIds: UserId[], subgroupsManagerIds: UserId[], collabManagerIds: UserId[], membershipsManagerIds: UserId[], memberIds: UserId[]}} group
   */
  constructor(group) {
