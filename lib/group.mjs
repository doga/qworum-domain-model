...
class Org {
   ...
   * @returns {UserId[]}
   */
  get managerIds(){return [...this.groupsManagerIds, ...this.membershipsManagerIds];}

  /**
   * @returns {UserId[]}
   */
  get participantIds(){return [...this.ownerIds, ...this.managerIds, ...this.memberIds];}
...
class Group {
   ...
   * @returns {UserId[]}
   */
  get managerIds(){return [...this.subgroupsManagerIds, ...this.partnershipsManagerIds, ...this.membershipsManagerIds];}
