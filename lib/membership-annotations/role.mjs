...
.setRole(
  new Role({
    ...
    description: new I18nText().setText('The user has read-only access to data when using Qworum services.', en)
  })
);


export default Role;
export {Role, platformRoleset};
