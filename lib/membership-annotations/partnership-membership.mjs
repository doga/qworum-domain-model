...
class PartnershipMembership {
   ...
   * @param {{partnershipMembershipId: PartnershipMembershipId | undefined, partnershipId: PartnershipId, groupId: GroupId, roleIds: IRI[] | undefined}} partnershipMembership
   * @throws {TypeError}
   */
  constructor(partnershipMembership) {
    ...
    if (!(
      ...
      (partnershipMembership.roleIds instanceof Array && partnershipMembership.roleIds.every(r => r instanceof IRI))
    )) {
