...
import { OrgId, GroupId, UserId, PersonaId, } from "./id.mjs";
...
class UserRole extends IRL {
  ...
  static groupCollabManager      = new UserRole(`${QRM}id/role/group/collab-manager`);
...
class Persona {
  ...
  /**
   * 
   * @param {{personaId: PersonaId | undefined, orgId: OrgId | undefined, groupId: GroupId | undefined, userId: UserId, userRoles: UserRole[]}} persona 
   * @throws {TypeError}
   */
  constructor(persona) {
  ...
  writeTo(rdfDataset){
    const
    personaId  = t.namedNode(`${this.personaId}`),
  ...
  static readFrom(rdfDataset){
    try {
      ...
      for (const personaIdQuad of personaIdsDataset) {
        ...
        personaId      = new PersonaId(`${personaIdTerm.value}`),
...
class OrgPersona extends Persona {
  /**
   * 
   * @param {{personaId: PersonaId | undefined, orgId: OrgId | undefined, groupId: GroupId | undefined, userId: UserId, userRoles: string[]}} persona 
   * @throws {TypeError}
   */
  constructor(persona) {
    super(persona);
