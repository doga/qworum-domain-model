...
class Persona {
   ...
   * An empty list means no roles.
   * @type {RoleId[]} 
   **/ 
  userRoleIds; // BUG remove this for now (from jslib, not from here)

  /** 
   * Defines the set of roles that the user is allowed to have when acting on behalf of the group in Qworum services.
   * An empty list means no roles. This property is ignored if partnerGroupIds is empty.
   * @type {RoleId[]} 
   **/ 
  groupRoleIds; // BUG this does not belong to Persona
   ...
   * @type {GroupId[]} 
   **/ 
  partnerGroupIds; // BUG this does not belong to Persona
