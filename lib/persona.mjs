// RDF
import {IRI, IRL, iri, rdfTerm as t } from "../deps.mjs";
...
const
ownerRole              = userrole`${QRM}id/role/owner`,
rootGroupsManagerRole  = userrole`${QRM}id/role/root-groups-manager`,
subgroupsManagerRole   = userrole`${QRM}id/role/subgroups-manager`,
collabManagerRole      = userrole`${QRM}id/role/collabs-manager`,
membershipsManagerRole = userrole`${QRM}id/role/memberships-manager`,
memberRole             = userrole`${QRM}id/role/member`;
