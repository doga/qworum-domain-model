...
import { IRI, URN, iri} from '../deps.mjs';
import { QRM } from "./util/rdf-prefixes.mjs";
...
class PasswordId extends IRI {
  ...
  static forUser(userId) {
    ...
    return new PasswordId(iri`${QRM}id/password/${userId.bareId}`);
  }
}
...
export { 
  Id, OrgId, GroupId, UserId, PasswordId, CollabId,
