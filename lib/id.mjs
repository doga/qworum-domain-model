...
//    * @param {(Id | Id[] | IdSet)} ids
//    * @returns {IdSet}
//    */
//   add(ids){
//     if (ids instanceof Id) {
//       ids = [ids];
//     } else if (ids instanceof Array && ids.every(id => id instanceof Id)) {
//     } else if (ids instanceof IdSet) {
//       ids = ids.members;
//     } else return this;
...
//       if(index === -1)continue;
//       this.#ids = this.#ids.slice(index, index+1);
//     }
...
//   /**
//    * Returns a new IdSet that is the union of this set and the arg set.
//    * @param {IdSet} idSet
//    * @returns {IdSet}
//    */
//   union(idSet){
//     if(!(idSet instanceof IdSet))idSet = new IdSet();
...
//   /**
//    * Returns a new IdSet that is the intersection of this set and the arg set.
//    * @param {IdSet} idSet
//    * @returns {IdSet}
//    */
//   intersection(idSet){
//     const res = new IdSet();
//     if(!(idSet instanceof IdSet))return res;
...
//   /**
//    * Returns a new IdSet that contains ids contained in this set or the arg set but not both.
//    * @param {IdSet} idSet
//    * @returns {IdSet}
//    */
//   symmetricDifference(idSet){
//     const res = new IdSet();
//     if(!(idSet instanceof IdSet))return new IdSet().add(this.members);
...
//    */
//   isSubsetOf(idSet){
//     if(!(idSet instanceof IdSet))return false;
...
//     if(!(idSet instanceof IdSet))return true;
